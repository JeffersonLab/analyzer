...
TEST_CASE("Detector Map Parser v2", "[Detectors]") // NOLINT(*-function-cognitive-complexity)
{
  ...
  {
    const char* printstr = R"OUT(THaCrateMap: size = 2
 Crate  Slot Start   End  Logi  Model  Type  Flg RefCh RefIx Plane  Sgnl
  ...
  {
    const char* printstr = R"OUT(THaCrateMap: size = 3
...
TEST_CASE("Read detector map from database", "[Detectors]") // NOLINT(*-function-cognitive-complexity)
{
  THaDetMap m;
  //TODO read a definition from an actual database file
