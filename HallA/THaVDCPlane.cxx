...
Int_t THaVDCPlane::DefineVariables( EMode mode )
{
  ...
  const vector<RVarDef> vars = {
    ...
    { .name = "wire",   .desc = "Active wire numbers",        .def = "fHits.THaVDCHit.GetWireNum()"              },
    { .name = "rawtime",.desc = "Raw TDC values of wires",    .def = "fHits.THaVDCHit.fRawTime"                  },
    { .name = "time",   .desc = "TDC values of active wires", .def = "fHits.THaVDCHit.fTime"                     },
    { .name = "nthit",  .desc = "tdc hits per channel",       .def = "fHits.THaVDCHit.fNthit"                    },
    { .name = "dist",   .desc = "Drift distances",            .def = "fHits.THaVDCHit.fDist"                     },
    { .name = "ddist",  .desc = "Drft dist uncertainty",      .def = "fHits.THaVDCHit.fdDist"                    },
    { .name = "trdist", .desc = "Dist. from track",           .def = "fHits.THaVDCHit.ftrDist"                   },
    { .name = "ltrdist",.desc = "Dist. from local track",     .def = "fHits.THaVDCHit.fltrDist"                  },
    { .name = "trknum", .desc = "Track number (0=unused)",    .def = "fHits.THaVDCHit.fTrkNum"                   },
    { .name = "clsnum", .desc = "Cluster number (-1=unused)", .def = "fHits.THaVDCHit.fClsNum"                   },
    { .name = "nclust", .desc = "Number of clusters",         .def = "GetNClusters()"                            },
    { .name = "clsiz",  .desc = "Cluster sizes",              .def = "fClusters.THaVDCCluster.GetSize()"         },
    { .name = "clpivot",.desc = "Cluster pivot wire num",     .def = "fClusters.THaVDCCluster.GetPivotWireNum()" },
    { .name = "clpos",  .desc = "Cluster intercepts (m)",     .def = "fClusters.THaVDCCluster.fInt"              },
    { .name = "slope",  .desc = "Cluster best slope",         .def = "fClusters.THaVDCCluster.fSlope"            },
    { .name = "lslope", .desc = "Cluster local (fitted) slope",.def = "fClusters.THaVDCCluster.fLocalSlope"      },
    { .name = "t0",     .desc = "Timing offset (s)",          .def = "fClusters.THaVDCCluster.fT0"               },
    { .name = "sigsl",  .desc = "Cluster slope error",        .def = "fClusters.THaVDCCluster.fSigmaSlope"       },
    { .name = "sigpos", .desc = "Cluster position error (m)", .def = "fClusters.THaVDCCluster.fSigmaInt"         },
    { .name = "sigt0",  .desc = "Timing offset error (s)",    .def = "fClusters.THaVDCCluster.fSigmaT0"          },
    { .name = "clchi2", .desc = "Cluster chi2",               .def = "fClusters.THaVDCCluster.fChi2"             },
    { .name = "clndof", .desc = "Cluster NDoF",               .def = "fClusters.THaVDCCluster.fNDoF"             },
    { .name = "cltcor", .desc = "Cluster Time correction",    .def = "fClusters.THaVDCCluster.fTimeCorrection"   },
    { .name = "cltridx",.desc = "Idx of track assoc w/cluster", .def = "fClusters.THaVDCCluster.GetTrackIndex()" },
    { .name = "cltrknum", .desc = "Cluster track number (0=unused)", .def = "fClusters.THaVDCCluster.fTrkNum"    },
    { .name = "clbeg", .desc = "Cluster start wire",          .def = "fClusters.THaVDCCluster.fClsBeg"           },
    { .name = "clend", .desc = "Cluster end wire",            .def = "fClusters.THaVDCCluster.fClsEnd"           },
    { .name = "npass", .desc = "Number of hit passes for cluster", .def = "fNpass" },
  };
