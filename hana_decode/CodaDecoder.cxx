...
// CODA 3 actually allows for 32 triggers.  But we have <= 8 for SBS.
// If you don't set psfact[N] (N=8 - 11) to a value, THaRunBase will 
// throw an error.  May need a better fix here.
	...
	Warning("prescale_decode","Mismatch in prescale factor: "
		"Trig %d  oldps %d   prescale.dat %d, Keeping old value",
		trig+1,(Int_t)psfact[trig],(Int_t)ps);
      }
      if (fDebug > 1)
	cout << "** psfact[ "<<trig+1<< " ] = "<<psfact[trig]<<endl;
