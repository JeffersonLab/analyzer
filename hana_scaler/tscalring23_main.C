...
//  tscalring_main.C
//
//  Analysis of data from ROC23, which is for GeN
//  R. Michaels, Feb 2006
//--------------------------------------------------------
...
// To get 6 data from Ring.  Present default.
#define READ6 
...
double rsum_clk[2],rsum_bcm[2],rsum_t3[2],rsum_l1a[2];
double rsum_num[2];
...
void resetSums() {
   ...
   memset(rsum_t3, 0, 2*sizeof(double));
