...
//  tscalroc23_main.C
//
//  Test of the 23 scalers which are read in the datastream
//  typically every 100 events.  
//  The focus is on the ring buffer data. 
//  R. Michaels, Feb 2006
//  This readout is different and is for GeN specifically.
//--------------------------------------------------------

// The ROC to find scalers (23 for GeN).
#define MYROC 23
...
// 32 channels of scaler data for two helicities.
     if (PRINTOUT) cout << "Scaler event ----> " << endl;
