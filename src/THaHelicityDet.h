...
//  THaHelicityDet *h = new THaHelicityDet("H","Beam helicity");
...
private:
  ...
  //THaHelicityDet( const THaHelicityDet& ) {}
  //THaHelicityDet& operator=( const THaHelicityDet& ) { return *this; }
  THaHelicity fHelicity;
