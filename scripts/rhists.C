...
c1 = new TCanvas("c1", "X");
t->Draw("CR_TR_x", "abs(CR_TR_x+0.25)<0.5");
c1->Update();
t->SetLineColor(kRed);
t->Draw("FR_TR_x", "abs(FR_TR_x+0.25)<0.5", "same");
t->SetLineColor(kBlack);
c1->Update();

c2 = new TCanvas("c2", "Y");
t->Draw("CR_TR_y", "abs(CR_TR_y)<0.15"); 
c2->Update();
t->SetLineColor(kRed);
...
t->Draw("CR_TR_th", "abs(CR_TR_th+0.05)<0.1");
c3->Update();
t->SetLineColor(kRed);
t->Draw("FR_TR_th", "abs(FR_TR_th+0.05)<0.1", "same");
t->SetLineColor(kBlack);
c3->Update();

c4 = new TCanvas("c4", "Phi");
t->Draw("CR_TR_ph", "abs(CR_TR_ph)<0.15");
c4->Update();
t->SetLineColor(kRed);
t->Draw("FR_TR_ph", "abs(FR_TR_ph)<0.15", "same");
t->SetLineColor(kBlack);
c4->Update();
...
t->Draw("CR_TR_y:CR_TR_x",
	"abs(CR_TR_x+0.4)<0.3&&abs(CR_TR_y)<0.05");
c10 = new TCanvas("c10", "Old X v Y");
t->Draw("FR_TR_y:FR_TR_x",
	"abs(FR_TR_x+0.4)<0.3&&abs(FR_TR_y)<0.05");

c11 = new TCanvas("c11", "New Theta v Phi");
t->Draw("CR_TR_ph:CR_TR_th", 
	"abs(CR_TR_th+0.05)<0.06&&abs(CR_TR_ph)<.05");
c12 = new TCanvas("c12", "Old Theta v Phi");
t->Draw("FR_TR_ph:FR_TR_th", 
	"abs(FR_TR_th+0.05)<0.06&&abs(FR_TR_ph)<.05");

c13 = new TCanvas("c13", "New X v Theta");
t->Draw("CR_TR_th:CR_TR_x", 
	"abs(CR_TR_x+0.4)<0.3&&abs(CR_TR_th+0.05)<0.1");
c14 = new TCanvas("c14", "Old X v Theta");
t->Draw("FR_TR_th:FR_TR_x", 
	"abs(FR_TR_x+0.4)<0.3&&abs(FR_TR_th+0.05)<0.1");
  
c15 = new TCanvas("c15", "New Y v Phi");
t->Draw("CR_TR_ph:CR_TR_y",
	"abs(CR_TR_ph)<0.05&&abs(CR_TR_y)<0.05");
c16 = new TCanvas("c16", "Old Y v Phi");
t->Draw("FR_TR_ph:FR_TR_y",
	"abs(FR_TR_ph)<0.05&&abs(FR_TR_y)<0.05");
 break;
...
t->Draw("FR_TR_x:CR_TR_x", "abs(FR_TR_x+0.25)<0.5&&abs(CR_TR_x+0.25)<0.5");
c20->Update();

c21 = new TCanvas("c21", "New Y v Old Y");
t->Draw("FR_TR_y:CR_TR_y", "abs(FR_TR_y)<0.15&&abs(CR_TR_y)<0.15");
c21->Update();

c22 = new TCanvas("c22", "New Theta v Old Theta");
t->Draw("FR_TR_th:CR_TR_th", "abs(CR_TR_th+0.05)<0.1&&abs(FR_TR_th+0.05)<0.1");
c22->Update();

c23 = new TCanvas("c23", "New Phi v Old Phi");
t->Draw("FR_TR_ph:CR_TR_ph", "abs(FR_TR_ph)<0.15&&abs(CR_TR_ph)<0.15");
c23->Update();
 break;
...
t->Draw("CR_TR_x-FR_TR_x", "(CR_TR_x-FR_TR_x)>-0.01&&(CR_TR_x-FR_TR_x)<0.01");
...
t->Draw("CR_TR_y-FR_TR_y", "(CR_TR_y-FR_TR_y)>-0.01&&(CR_TR_y-FR_TR_y)<0.01");
...
t->Draw("CR_TR_th-FR_TR_th", "(CR_TR_th-FR_TR_th)>-0.01&&(CR_TR_th-FR_TR_th)<0.01");
...
t->Draw("CR_TR_ph-FR_TR_ph", "(CR_TR_ph-FR_TR_ph)>-0.01&&(CR_TR_ph-FR_TR_ph)<0.01");
...
t->Draw("CR_TG_y", "abs(CR_TG_y)<0.06"); 
c52->Update();
t->SetLineColor(kRed);
t->Draw("FR_TG_y", "abs(FR_TG_y)<0.06", "same");
t->SetLineColor(kBlack);
c52->Update();

c53 = new TCanvas("c53", "Theta");
t->Draw("CR_TG_th", "abs(CR_TG_th+0.05)<0.2");
c53->Update();
t->SetLineColor(kRed);
t->Draw("FR_TG_th", "abs(FR_TG_th+0.05)<0.2", "same");
t->SetLineColor(kBlack);
c53->Update();

c54 = new TCanvas("c4", "Phi");
t->Draw("CR_TG_ph", "abs(CR_TG_ph)<0.1");
c54->Update();
t->SetLineColor(kRed);
t->Draw("FR_TG_ph", "abs(FR_TG_ph)<0.1", "same");
t->SetLineColor(kBlack);
c54->Update();
...
c55 = new TCanvas("c55", "Target Theta v. Phi");
 c55->Divide(1,2);
 c55->cd(1);
 t->Draw("CR_TG_th:CR_TG_ph", "abs(CR_TG_th)<0.1&&abs(CR_TG_ph)<0.1");
 c55->cd(2);
 t->Draw("FR_TG_th:FR_TG_ph", "abs(FR_TG_th)<0.1&&abs(FR_TG_ph)<0.1");
c55->Update();
...
c105 = new TCanvas("c105", "Target Theta v. Delta");
 c105->Divide(1,2);
 c105->cd(1);
 t->Draw("CR_TG_dp:CR_TG_ph", "abs(CR_TG_ph)<0.05&&abs(CR_TG_dp+0.025)<0.025");
 c105->cd(2);
 t->Draw("FR_TG_dp:FR_TG_ph", "abs(FR_TG_ph)<0.05&&abs(FR_TG_dp+0.025)<0.025");
c105->Update();
...
t->Draw("CR_TG_dp-FR_TG_dp", 
	"(CR_TG_dp-FR_TG_dp)>-0.01&&(CR_TG_dp-FR_TG_dp)<0.01");
TH1F *xdhist = (TH1F*)gPad->GetPrimitive("htemp");
xdhist->Fit("gaus");
 TF1 *xf = xdhist->GetFunction("gaus");
 cout<<"chi-squared         = "<<xf->GetChisquare()<<endl;
...
t->Draw("CR_TG_ph-FR_TG_ph", 
	"(CR_TG_ph-FR_TG_ph)>-0.01&&(CR_TG_ph-FR_TG_ph)<0.01");
TH1F *pdhist = (TH1F*)gPad->GetPrimitive("htemp");
pdhist->Fit("gaus");
 TF1 *pf = pdhist->GetFunction("gaus");
 cout<<"chi-squared         = "<<pf->GetChisquare()<<endl;
...
t->Draw("CR_TR_rx", "abs(CR_TR_rx+0.25)<0.5");
c71->Update();
t->SetLineColor(kRed);
t->Draw("FR_TR_rx", "abs(FR_TR_rx+0.25)<0.5", "same");
t->SetLineColor(kBlack);
c71->Update();

c72 = new TCanvas("c72", "Y");
t->Draw("CR_TR_ry", "abs(CR_TR_ry)<0.15"); 
c72->Update();
t->SetLineColor(kRed);
t->Draw("FR_TR_ry", "abs(FR_TR_ry)<0.15", "same");
t->SetLineColor(kBlack);
c72->Update();

c73 = new TCanvas("c73", "Theta");
t->Draw("CR_TR_rth", "abs(CR_TR_rth+0.05)<0.1");
c73->Update();
t->SetLineColor(kRed);
t->Draw("FR_TR_rth", "abs(FR_TR_rth+0.05)<0.1", "same");
t->SetLineColor(kBlack);
c73->Update();

c74 = new TCanvas("c74", "Phi");
t->Draw("CR_TR_rph", "abs(CR_TR_rph)<0.15");
c74->Update();
t->SetLineColor(kRed);
t->Draw("FR_TR_rph", "abs(FR_TR_rph)<0.15", "same");
t->SetLineColor(kBlack);
c74->Update();
...
t->Draw("CR_TR_ry:CR_TR_rx",
	"abs(CR_TR_rx+0.4)<0.3&&abs(CR_TR_ry)<0.05");
c80 = new TCanvas("c80", "Old X v Y");
t->Draw("FR_TR_ry:FR_TR_rx",
	"abs(FR_TR_rx+0.4)<0.3&&abs(FR_TR_ry)<0.05");

c81 = new TCanvas("c81", "New Theta v Phi");
t->Draw("CR_TR_rph:CR_TR_rth", 
	"abs(CR_TR_rth+0.05)<0.06&&abs(CR_TR_rph)<.05");
c82 = new TCanvas("c82", "Old Theta v Phi");
t->Draw("FR_TR_rph:FR_TR_rth", 
	"abs(FR_TR_rth+0.05)<0.06&&abs(FR_TR_rph)<.05");

c83 = new TCanvas("c83", "New X v Theta");
t->Draw("CR_TR_rth:CR_TR_rx", 
	"abs(CR_TR_rx+0.4)<0.3&&abs(CR_TR_rth+0.05)<0.1");
c84 = new TCanvas("c84", "Old X v Theta");
t->Draw("FR_TR_rth:FR_TR_rx", 
	"abs(FR_TR_rx+0.4)<0.3&&abs(FR_TR_rth+0.05)<0.1");
  
c85 = new TCanvas("c85", "New Y v Phi");
t->Draw("CR_TR_rph:CR_TR_ry",
	"abs(CR_TR_rph)<0.05&&abs(CR_TR_ry)<0.05");
c86 = new TCanvas("c86", "Old Y v Phi");
t->Draw("FR_TR_rph:FR_TR_ry",
	"abs(FR_TR_rph)<0.05&&abs(FR_TR_ry)<0.05");
 break;
...
t->Draw("FR_TR_rx:CR_TR_rx", "abs(FR_TR_rx+0.25)<0.5&&abs(CR_TR_rx+0.25)<0.5");
c20->Update();

c91 = new TCanvas("c21", "New Y v Old Y");
t->Draw("FR_TR_ry:CR_TR_ry", "abs(FR_TR_ry)<0.15&&abs(CR_TR_ry)<0.15");
c21->Update();

c92 = new TCanvas("c22", "New Theta v Old Theta");
t->Draw("FR_TR_rth:CR_TR_rth", "abs(CR_TR_rth+0.05)<0.1&&abs(FR_TR_rth+0.05)<0.1");
c22->Update();

c93 = new TCanvas("c23", "New Phi v Old Phi");
t->Draw("FR_TR_rph:CR_TR_rph", "abs(FR_TR_rph)<0.15&&abs(CR_TR_rph)<0.15");
c93->Update();
 break;
