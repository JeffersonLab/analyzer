...
const Double_t OldVDCHit::kBig = 1.e38; // Arbitrary large value

//_____________________________________________________________________________
Double_t OldVDCHit::ConvertTimeToDist(Double_t slope)
{
  // Converts TDC time to drift distance
  // Takes the (estimated) slope of the track as an argument
  
  OldVDCTimeToDistConv* ttdConv = (fWire) ? fWire->GetTTDConv() : nullptr;
...
//_____________________________________________________________________________
Int_t OldVDCHit::Compare( const TObject* obj ) const 
{
  // Used to sort hits
  ...
  const OldVDCHit* hit = static_cast<const OldVDCHit*>( obj );
