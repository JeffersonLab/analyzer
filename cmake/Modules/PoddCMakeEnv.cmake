...
macro(set_cxx_std cxx_flags)
  ...
  if(CMAKE_MATCH_COUNT EQUAL 3)
    set(found_std ${CMAKE_MATCH_3})
    if(found_std STREQUAL "2a")
      set(found_std "20")
    endif()
    if(found_std STREQUAL "2b")
      set(found_std "23")
    endif()
    if(found_std STREQUAL "2c")
      set(found_std "26")
    endif()
    if(found_std GREATER_EQUAL min_cxx_std)
      set(CMAKE_CXX_STANDARD ${found_std})
...
macro(set_compiler_flags _suggested_flags)
  ...
  check_cxx_compiler_flag(-momit-leaf-frame-pointer cxx-compiler-supports-momit-leaf-frame-pointer)
  ...
  if(cxx-compiler-supports-momit-leaf-frame-pointer)
    set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "${CMAKE_CXX_FLAGS_RELWITHDEBINFO} -mno-omit-leaf-frame-pointer")
  endif()
  unset(cxx-compiler-supports-fomit-frame-pointer)
  unset(cxx-compiler-supports-momit-leaf-frame-pointer)
